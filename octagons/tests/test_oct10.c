...
int main(int argc, char **argv) {
	...
	//meet == glb, join == lub
	//join is associative
	klee_assert(oct_is_eq(man, oct_join(man, false, oct_join(man, false, octagon1, octagon2), octagon3),
			oct_join(man, false, octagon1, oct_join(man, false, octagon2, octagon3))));
	return 0;
}
