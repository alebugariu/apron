...
int camlidl_transl_table_generator0_enum_8[5] = {
  LINE,
  RAY,
  VERTEX,
  LINEMOD,
...
{
  int _c2;
  _c2 = camlidl_transl_table_generator0_enum_8[Int_val(_v1)];
  return _c2;
}
...
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_generator0_enum_8, 5, "enum gentyp: bad enum gentyp value");
  return _v2;
}
