...
bool create_pool(ap_manager_t* man, pk_t * top,
...
bool get_polyhedron(pk_t** polyhedron, ap_manager_t* man,
		pk_t * top, unsigned char *number, const long *data,
...
void print_polyhedron(ap_manager_t* man, pk_t* polyhedron,
