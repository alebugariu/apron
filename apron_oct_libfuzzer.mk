...
#OBJS=$(APRON)/*.o $(OCTAGONS)/*.o $(OCTAGONS)/tests/libFuzzer/test_oct.o
...
test:	octagons/tests/libFuzzer/*.c	
	...
	clang $(INCLUDES) -O0 -c -g -DNUM_LONGDOUBLE test_oct.c; \
		...
		clang -lstdc++ -fsanitize=address -fsanitize-coverage=trace-pc-guard -DNUM_LONGDOUBLE -I /usr/local/include $(INCLUDES) $(OBJS) $(LIBS) test_oct$${number}.c /home/libFuzzer.a $(OCTAGONS)/liboctD.so -o test$${number} -lmpfr -lgmp; \
		startTime=`date +%s` ; \
