...
int main(int argc, char **argv) {
	...
	double values0[8][2] = { { -9185, -7468 }, { -4135, 3562 }, { -4703, 971 },
			{ -9029, -4693 }, { -2651, 5530 }, { 3715, 8699 }, { 3874, 9262 }, {
					7031, 9857 } };
	t1p_t* zonotope15 = create_zonotope(man, dim, values0);
	printf("successfully created zonotope15:\n");
	t1p_fprint(stdout, man, zonotope15, NULL);

	double values[9] = { LONG_MIN, LONG_MIN, -1, LONG_MIN, LONG_MIN, LONG_MIN,
			-1, LONG_MIN, LONG_MIN };

	t1p_t* assignment_result = assign(man, zonotope15, 0, dim, values);
